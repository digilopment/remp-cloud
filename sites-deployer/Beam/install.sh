...
CONTAINER="${PROJECT_NAME}-beam"
APP_DIR="Beam"   # cesta v kontejnere, kde je Laravel aplikácia

cp config/.env ../../apps/$APP_DIR/.env

echo "Spúšťam inštaláciu Beam CRM cez Docker ($CONTAINER)..."
...
echo "Hotovo! Beam CRM je pripravený."
